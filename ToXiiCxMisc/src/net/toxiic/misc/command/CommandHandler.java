	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
	    ...
	    if (args.length == 0) {
	       ...
	       return true;
	    	  	...
	    	  	if (args.length == 1){
	    	  		if (args[0].equalsIgnoreCase("fi") && p.hasPermission("toxiicmisc.floatingitem")) {
	                	...
	                	if(args.length == 2) {
	                		if (args[0].equalsIgnoreCase("setunb") && p.hasPermission("toxiicmisc.unbreaking")) { 
	                			...
	                			if(args.length == 3) {
	                				if (args[0].equalsIgnoreCase("setdur") && p.hasPermission("toxiicmisc.duribility")) { 
	                					if(p.getInventory().getItemInMainHand() != null) {
	                						p.getInventory().getItemInMainHand().setDurability(Short.valueOf(args[0]));
	                						return true;
	                				}
	                			} else
	                				if(args.length == 4) {
	                					if (args[0].equalsIgnoreCase("letter") && p.hasPermission("toxiicmisc.letters")) { 
